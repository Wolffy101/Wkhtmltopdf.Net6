...
public abstract class WkhtmlDriver
{
    ...
    public static byte[] Convert(string switches, string html)
    {
        var dir = Path.GetDirectoryName(Assembly.GetEntryAssembly().Location);
        var wkhtmlPath = Path.Combine(dir, "rotativa");
        ...
        else
        {
            ...
            {
                rotativaLocation = Path.Combine(wkhtmlPath, "LinuxArm64", "wkhtmltopdf");
            }
            else
            {
